            ...
            <div class="col-xlg-12 col-small-stats">
              <div class="row">
                ...
                <div class="panel-header bg-dark">
                  <h6 class="panel-title" style="">Documents(* Upload your Invoice.)</h6>
                   </div>
        ...
        ?>
                    ...
                    <form data-style="arrow" role="form" enctype="multipart/form-data" method="post" action="<?= site_url('quotes/upload_invoice_action'); ?>">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    ...
                                    <input type="file" name="document_file" class="form-control" required>
                                      <input type="hidden" name="vid" value="<?php echo $supplier->supplier_id; ?>" class="form-control" required>
