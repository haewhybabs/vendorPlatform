            ...
            <div class="col-xlg-12 col-small-stats">
              <div class="row">
                ...
                <div class="panel-header bg-dark">
                  <h6 class="panel-title" style="">Documents(* Upload your quotations.)</h6>
                   </div>
        ...
        ?>
                    ...
                    <form data-style="arrow" role="form" enctype="multipart/form-data" method="post" action="<?= site_url('quotes/upload_action'); ?>">
