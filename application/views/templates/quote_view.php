...
<p>Department of Procurement is department that’s required to procure services, materials, equipment and construction while ensuring that quality, safety, and cost-effectiveness are achieved for Living Faith Church Worldwide Faith Tabernacle Ota.</p>
        ...
        <table id="customers">
           ...
           <tr>
            ...
            <th>Total</th>
             ...
             <?php  $num= 1;?>
             <?php $x=0;?>
             <?php if($getprice==false):?>
               <div class="well">
                 No data found
               </div>
               <?php else:?>
               <?php foreach($getprice as $li):?>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            $number=$li->unit_price;
                             echo "N ".number_format($number, 2);
                             ?>                        
                          </td>
                          <td>
                            <?php $x=$li->unit_price*$li->quantity;
                            echo "N ".number_format($x, 2);?>
                          </td>
   ...
   <a href="<?=base_url('Quotes');?>" class="btn btn-primary">Go back</a>
