   ...
   <p><strong>REQUIREMENTS</strong></p>
    ...
    <div class="details-box">
        <table id="customers">
           ...
           <tr>
            ...
            <th>PRICE</th>
             ...
             <?php echo form_open('Quotes/upload_price');?>
                 <input type="hidden" name="product_specification[<?=$x;?>]" value="<?=$li->product_specification;?>">
                 <input type="hidden" name="quantity[<?=$x;?>]" value="<?=$li->quantity;?>">
                ...
                <input type="hidden" name="vendor_ID" value="<?=$li->vendor_ID;?>">
                 ...
                 <input type="hidden" name="product_ID[<?=$x;?>]" value="<?=$li->product_id;?>">
                        ...
                        <tr>
                          ...
                          <td>
                                 <input type="text" name="unit_price[<?=$x;?>]" class="form-control" placeholder="N">                         
                          </td>
           ...
           <?php if($li->process_status_ID > 2):
           else:?>
           <a href="<?= base_url();?>Quotes/Edit/<?=$li->rfq_ID;?>" class="btn btn-warning">Edit Specification</a>
            <?php endif;?>
    </div>
